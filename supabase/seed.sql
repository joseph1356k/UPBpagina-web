...
INSERT INTO public.ceremonies
  (id, name, event_type, email_template, date, start_time, end_time, venue, campus, faculty, status, registration_closes_at, max_guests_default)
VALUES
